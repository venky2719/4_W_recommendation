...
# Make the plot
rects1 = ax.bar(r1, prices, color='r', width=barWidth, edgecolor='black', label='Price')
rects2 = ax.bar(r2, mileages, color='yellow', width=barWidth, edgecolor='white', label='Mileage')
